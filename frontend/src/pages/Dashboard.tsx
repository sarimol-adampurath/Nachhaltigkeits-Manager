...
export const Dashboard = () => {
  ...
  const { logs, loading, error, deleteLog, refetch, totalCount, hasNext, hasPrevious } = useEmission(startDate, endDate, currentPage);
                  ...
                  <div className="p-4 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg font-medium text-sm transition-all disabled:opacity-40 disabled:cursor-not-allowed bg-slate-100 hover:bg-slate-200 text-slate-700"
                      >
                        Previous
                      </button>
                      <div className="flex items-center gap-1">
                        <span className="px-3 py-1.5 rounded-lg bg-emerald-600 text-white text-sm font-bold">
                          {currentPage}
                        </span>
